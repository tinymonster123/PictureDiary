...
Follow these rules strictly for comic narrative extraction:
- **Sequential Focus**: Order scenes chronologically to support comic panel flow
- **Visual Emphasis**: Prioritize elements that can be clearly visualized in comic panels
- **Character Consistency**: Provide detailed character descriptions that will ensure visual consistency across panels
- **Continuity Elements**: Include objects and settings that provide visual continuity between scenes
...
- **Precision**: Keep descriptions detailed enough for visual consistency but concise and objective.
- **Output Format**: Do not output any text other than the single, final JSON object.

Here is an example for comic narrative extraction:
...
\`\`\`json
{
  ...
  "characters": [
    {"name": "我", "description": "The diary author, a young adult office worker"},
    {"name": "小王", "description": "A colleague from work, friendly and informative"},
    {"name": "Lucky", "description": "My pet dog, small and stays at home alone"}
  ],
  "objects": ["红伞", "office desk", "computer"],
  "setting": "Home apartment and office building on a rainy morning"
}
\`\`\`
